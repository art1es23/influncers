...
<!-- <div class="regional_offices">
	<div class="container">
		<div class="regional_offices_title">
		    regional offices
		</div>
		<div class="regional_offices_items">
		<div class="regional_offices_item">
			<div class="regional_offices_item_title">Anatol Equipment Manufacturing Co.</div>
			<div class="regional_offices_item_name">World Headquarters</div>
			<div class="regional_offices_item_location"><span>Adress:</span> 919 Sherwood Drive, Lake Bluff, IL 60044, USA</div>
			<div class="regional_offices_item_phone"><span>Contact phone:</span> 847-367-9760</div>
			<div class="regional_offices_item_service"><span>Service:</span> 847-582-1825</div>
			<div class="regional_offices_item_fax"><span>Fax:</span> 847-582-1854</div>
			<div class="regional_offices_item_mail"><span>Mail:</span> sales@anatol.com</div>
		</div>
		<div class="regional_offices_item">
			<div class="regional_offices_item_title">Anatol Europe</div>
			<div class="regional_offices_item_name">European Headquarters</div>
			<div class="regional_offices_item_location"><span>Adress:</span> Ul Rejonowa 10, 17-100 Bielsk Podlaski, Poland</div>
			<div class="regional_offices_item_phone"><span>Contact phone:</span> (+48) 85 731 93 00</div>
			<div class="regional_offices_item_fax"><span>Fax:</span> (+48) 85 730 1779</div>
			<div class="regional_offices_item_mail"><span>Mail:</span> internationalsales@anatol.com</div>
		</div>
		<div class="regional_offices_item">
			<div class="regional_offices_item_title">Anatol Ukraine</div>
			<div class="regional_offices_item_name">European Office</div>
			<div class="regional_offices_item_location"><span>Adress:</span> Smilyvykh Street, 28A, Lviv, Ukraine</div>
			<div class="regional_offices_item_phone"><span>Contact phone:</span> +38 093 399 89 76</div>
			<div class="regional_offices_item_fax"><span>Fax:</span> 847-582-1854</div>
			<div class="regional_offices_item_mail"><span>Mail:</span> internationalsales@anatol.com</div>
		</div>
		</div>
...
<div class="regional-offices">
    <div class="regional-offices--wrapper">
        <h2 class="regional-offices__title">Regional Offices</h2>
        <div class="regional-offices__item regional-location">
            <h3 class="regional-location__title">Anatol Equipment Manufacturing Co.</h3>
            <p class="regional-location__legend">World Headquarters</p>
            <ul class="location-data">
                <li class="location-data__item" data-name="address">919 Sherwood Drive, Lake Bluff, IL 60044, USA</li>
                <li class="location-data__item" data-name="phone">
                    <a href="tel:777777777" class="location-data__link">847-367-9760</a>
                </li>
                <li class="location-data__item" data-name="phone">
                    <a href="tel:777777777" class="location-data__link">847-582-1825</a>
                </li>
                <li class="location-data__item" data-name="print">
                    <a href="tel:777777777" class="location-data__link">847-582-1854</a>
                </li>
                <li class="location-data__item" data-name="email">
                    <a href="email:sales@anatol.com" class="location-data__link">sales@anatol.com</a>
                </li>
            </ul>
        </div>
        <div class="regional-offices__item regional-location">
            <h3 class="regional-location__title">Anatol Europe</h3>
            <p class="regional-location__legend">European Headquarters</p>
            <ul class="location-data">
                <li class="location-data__item" data-name="address">Ul Rejonowa 10, 17-100 Bielsk Podlaski, Poland</li>
                <li class="location-data__item" data-name="phone">
                    <a href="tel:777777777" class="location-data__link">(+48) 85-731-9300</a>
                </li>
                <li class="location-data__item" data-name="print">
                    <a href="tel:777777777" class="location-data__link">(+48) 85-730-1779</a>
                </li>
                <li class="location-data__item" data-name="email">
                    <a href="email:internationalsales@anatol.com"
                        class="location-data__link">internationalsales@anatol.com</a>
                </li>
            </ul>
        </div>
        <div class="regional-offices__item regional-location">
            <h3 class="regional-location__title">Anatol Ukraine</h3>
            <p class="regional-location__legend">European Office</p>
            <ul class="location-data">
                <li class="location-data__item" data-name="address">Smilyvykh Street, 28A, Lviv, Ukraine</li>
                <li class="location-data__item" data-name="phone">
                    <a href="tel:777777777" class="location-data__link">(+38) 093-399-89-76</a>
                </li>
                <li class="location-data__item" data-name="print">
                    <a href="tel:777777777" class="location-data__link">847-582-1854</a>
                </li>
...
<div class="video_section">
	<video id="videobcg" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
        <source src="<?php bloginfo('template_url'); ?>/001.mp4" type="video/mp4">
	</video>
		...
		<div class="video_section--wrapper container">
			<div class="contact_text">
				<div class="contact_text_wrap">
					...
					<div class="contact_text_location">
						<h4 class="contact-description__title location-caption" data-name="address"]>Location</h4>
						<a href="http://" target="_blank" rel="noopener noreferrer">919 Sherwood Drive Lake Bluff, IL 60044,
							USA</a>
					</div>
					<div class="contact_text_phone">
						<h4 class="contact-description__title phone-caption" data-name="phone"]>Phone</h4>
						<a href="tel:+847-367-9760">847-367-9760</a>
					</div>
					<div class="contact_text_email">
						<h4 class="contact-description__title email-caption" data-name="email"]>Email</h4>
						<a href="mailto:info@anatol.com">info@anatol.com</a>
					</div>
				</div>
			</div>
				...
				<form id="__vtigerWebForm" name="Get a quote on Volt Landing" action="" method="post" accept-charset="utf-8" class="get_quote snapforms" enctype="multipart/form-data">
					...
					<div class="form-row">
						<div class="half">
							...
							<input class="form-input" type="tel" name="phone" placeholder="Phone Number*" maxlength="18" id="tel" required="">
						</div>
						<div class="half">
