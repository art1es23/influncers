...
*/
get_header(); ?>
<div <?php if(get_field('banner_img')){ ?> style="background-image: linear-gradient( to right, rgba(0, 0, 0, 0.65) 0%, rgba(0, 0, 0, 0.65) 100% ), url(<?php echo get_field('banner_img'); ?>);"
<?php }?> class="hero">
	...
	<div class="about-us--wrapper container">
		<div class="about-us__info">
			<div class="about-us__title">
			   <?php echo get_field('title_about_us_anatol'); ?>
			</div>
			<div class="about-us__description">
			   <?php echo get_field('description_about_us_anatol'); ?>
			</div>
		</div>
		<div class="about-us_img">
			<img src="<?php echo get_field('img_about_us_anatol'); ?>" alt="">
		</div>
	</div>
</div>
...
<div id="scroll" class="wrapper_form">
   <div style="padding: 70px 0 70px 0;" class="container">
