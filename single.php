...
<div class="related-section">
   <div class="container related-section--wrapper">
      <!-- <div class="section_title"> -->
         <h2 class="related-section__title">More Success Stories</h2>
      <!-- </div> -->
   ...
   if ($categories) {
      ...
      foreach($categories as $individual_category) $category_ids[] = $individual_category->term_id;
         ...
         if( $my_query->have_posts() ) {
            echo '<div class="related-section__slider slider-list-influencers">';
      ...
      <div class="slider-list-influencers__nav slider-btns">
         <div class="slider-btns__item slider-btns__item--prev"></div>
         <div class="slider-btns__item slider-btns__item--next"></div>
      </div>
   </div>
</div>
...
<div class="another-equipment">
   ...
   <div  class="list-equipment">
      <!-- <div class="caterpillar"> -->
         <div class="list-equipment__item block_presss">
            ...
            <div class="list-equipment__item--front">
               ...
               <!-- </div> -->
               <h4 class="list-equipment__title">Screen Printing Presses</h4>
               <!-- <div class="list-equipment__info"> -->
         ...
         <div class="list-equipment__item block_dryers" >
            <div class="list-equipment__item--back">
            </div>
            <div class="list-equipment__item--front">
               <!-- <div class="image"> -->
               ...
               <!-- </div> -->
               <h4 class="list-equipment__title">Conveyor Dryers</h4>
               <!-- <div class="list-equipment__info"> -->
               <ul class="list-equipment__info ">
         ...
         <div class="list-equipment__item block_flash">
            <div class="list-equipment__item--back">
            ...
            <div class="list-equipment__item--front">
               ...
               <!-- </div> -->
               <h4 class="list-equipment__title">Flash Cure Units</h4>
               <!-- <div class="list-equipment__info"> -->
               <ul class="list-equipment__info">
         ...
         <div class="list-equipment__item block_pre-press">
            <div class="list-equipment__item--back">
            ...
            <div class="list-equipment__item--front">
               ...
               <!-- </div> -->
               <h4 class="list-equipment__title">Pre-Press Equipment</h4>
               <!-- <div class="list-equipment__info"> -->
               <ul class="list-equipment__info">
         ...
         <div class="list-equipment__item block_accessories">
            <div class="list-equipment__item--back">
            ...
            <div class="list-equipment__item--front">
               ...
               <!-- </div> -->
               <h4 class="list-equipment__title">Printing Accessories</h4>
               <!-- <div class="list-equipment__info"> -->
               <ul class="list-equipment__info">
