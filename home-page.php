...
<?php
    ...
    <?php endforeach; ?>
		...
		<li class="accordeon-slide-list__item accordeon-slide view_more">
...
<div class="about-us">
	<div class="about-us--wrapper container">
		...
		<div class="about-us_img">
			<img src="<?php echo get_field('img_about_us'); ?>" alt="">
		</div>
	</div>
</div>
...
<div id="scroll" class="wrapper_form">
   <div class="container">
		...
		<form id="__vtigerWebForm" name="Get a quote on Volt Landing" action="" method="post" accept-charset="utf-8" class="form-inner get_quote snapforms" enctype="multipart/form-data">
